...
const navItems = [
  { href:'/dashboard',           label:'Dashboard',       roles:['admin','sub_admin','viewer'], icon:'M1 1h6v6H1zM9 1h6v6H9zM1 9h6v6H1zM9 9h6v6H9z' },
  { href:'/reports',             label:'Reports',         roles:['admin','sub_admin','viewer'], icon:'M1 12l4-5 3 2 4-5 3 2M1 15h14' },
  { href:'/upload',              label:'Upload Data',     roles:['admin'],                     icon:'M14 2H6a2 2 0 0 0-2 2v6M14 2l4 4M18 6h-4V2M12 18v-6M9 15l3 3 3-3' },
  { href:'/admin',               label:'Manage Users',    roles:['admin'],                     icon:'M10 8a3 3 0 100-6 3 3 0 000 6zM1 14s1-4 9-4', divider:true },
]
